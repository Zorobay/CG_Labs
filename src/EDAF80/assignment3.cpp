...
edaf80::Assignment3::run() {
    ...
    std::vector<bonobo::mesh_data> objects = bonobo::loadObjects("ogre.obj");
    if (objects.empty()) {
    ...
    bonobo::mesh_data const &box = objects.front();
    ...
    program_manager.CreateAndRegisterProgram({{ShaderType::vertex,   "EDAF80/normal_map.vert"},
                                              {ShaderType::fragment, "EDAF80/normal_map.frag"}}, normal_map_shader);
